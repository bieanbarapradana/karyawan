...
<body>
    <div class="container">
		...
		<button class="btn btn-info" ><a href="<?=base_url('Person/person_tetap');?>"><i class="glyphicon glyphicon-plus"></i></a> Tetap</button>
        <br />
        <br />
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('person/ajax_list_person_tetap')?>",
            "type": "POST"
        },
