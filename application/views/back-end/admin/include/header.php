...
<!-- Mirrored from coderthemes.com/simple_1.1/dark/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 26 Jan 2017 05:07:58 GMT -->
<head>
        <meta charset="utf-8" />
                ...
                <div class="topbar-left">
                    <div class="">
                        <a href="index.html" class="logo">
                            <img src="<?=base_url('assets/back-end/images/logo.png')?>" alt="logo" class="logo-lg" />
                            <img src="<?=base_url('assets/back-end/images/logo_sm.png');?>" alt="logo" class="logo-sm hidden" />
                        </a>
                    </div>
                </div>
                            ...
                            <ul class="nav navbar-nav navbar-right top-navbar-items-right pull-right">
                                ...
                                <li class="dropdown top-menu-item-xs">
                                    <a href="#" data-target="#" class="dropdown-toggle menu-right-item" data-toggle="dropdown" aria-expanded="true">
                                        <i class="mdi mdi-bell"></i><span class="label label-danger" id="notification_count"></span>
                                ...
                                <li class="dropdown top-menu-item-xs">
                                    <a href="#" class="dropdown-toggle menu-right-item profile" data-toggle="dropdown" aria-expanded="true"><img src="<?=base_url('assets/back-end/images/users/avatar-1.jpg')?>" alt="user-img" class="img-circle"> </a>
                    ...
                    <div class="scrollbar-wrapper">
                        <div>
                            ...
                            <div class="user-details">
                                <div class="pull-left">
                                    <img src="<?=base_url('assets/back-end/images/users/avatar-1.jpg');?>" alt="" class="thumb-md img-circle">
                                </div>
                                <div class="user-info">
                                    <a href="#"><?=$this->session->userdata('full_name')?></a>
